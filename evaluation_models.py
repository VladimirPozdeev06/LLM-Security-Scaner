...
def compute_format_metrics(data:pd.DataFrame,responses:pd.DataFrame)->None:
    format_compliance = 1 - round(len(responses[responses['analysis_part'].isna()]) / len(responses), 3)
